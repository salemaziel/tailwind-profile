...
<section className="px-4 py-12 text-center">
  ...
  <a className="inline-block px-8 py-4 font-semibold leading-none text-white bg-indigo-600 rounded shadow hover:bg-indigo-700" href="#">Return to the homepage</a>
</section>
